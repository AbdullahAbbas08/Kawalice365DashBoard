...
export class NavService implements OnDestroy {
	...
	MENUITEMS: Menu[] = [
		...
		{
			title: 'Widgets', icon: 'box', type: 'sub', active: false, children: [
		...
		{
			title: 'عارض الصور', icon: 'box', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Sliders', title: 'إدارة عارض الصور ', type: 'link' },
				// { path: '/project/create', title: 'إضافة تصنيف جـديد', type: 'link' }
				// { path: '/project/Programs', title: 'قائمة البرامج ', type: 'link' },
				// { path: '/project/createProgram', title: 'إضافة برنامج جديد ', type: 'link' },
			]
		},
		{
			title: 'التصنيفات', icon: 'box', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/list', title: 'إدارة التصنيفات ', type: 'link' },
				{ path: '/project/create', title: 'إضافة تصنيف جـديد', type: 'link' }
				// { path: '/project/Programs', title: 'قائمة البرامج ', type: 'link' },
				// { path: '/project/createProgram', title: 'إضافة برنامج جديد ', type: 'link' },
			]
		...
		{
			title: 'البرامج', icon: 'film', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Programs', title: 'إدارة البرامج ', type: 'link' },
				{ path: '/project/createProgram', title: 'إضافة برنامج جـديد ', type: 'link' }
			]
		},
		{
			title: 'أنواع البرامج', icon: 'slack', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/ProgramTypes', title: 'إدارة أنواع البرامج ', type: 'link' },
				{ path: '/project/CreateProgramType', title: 'إضافة نوع برنامج جـديد ', type: 'link' }
			]
		},
		{
			title: 'المواسـم', icon: 'server', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Seasons', title: 'إدارة المواسـم ', type: 'link' },
				{ path: '/project/createSeason', title: 'إضافة موسـم جـديد ', type: 'link' }
			]
		},
		{
			title: 'الحـلـقات', icon: 'airplay', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Episodes', title: 'إدارة الحـلـقات ', type: 'link' },
				{ path: '/project/createEpisode', title: 'إضافة حـلـقة جـديدة ', type: 'link' }
			]
		},
		{
			title: 'مقدمين البرامج', icon: 'user', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Interviewers', title: 'إدارة مقدمى البرامج ', type: 'link' },
				{ path: '/project/createInterviewer', title: 'إضافة مقدم برامج جـديد ', type: 'link' }
			]
		},
		{
			title: 'الإعلانات', icon: 'list', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Advertisment', title: 'إدارة  الإعلانات ', type: 'link' },
				{ path: '/project/createAdvertisment', title: 'إضافة إعلان ', type: 'link' }
			]
		},
		{
			title: 'تارجت الإعلان', icon: 'command', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Target', title: 'إدارة  تارجت الإعلان ', type: 'link' },
				{ path: '/project/createTarget', title: 'إضافة تارجت إعلان ', type: 'link' }
			]
		},
		{
			title: 'أبعاد الإعلان', icon: 'edit', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Style', title: 'إدارة  أبعاد الإعلان ', type: 'link' },
				{ path: '/project/createStyle', title: 'إضافة أبعاد إعلان ', type: 'link' }
			]
		},
		{
			title: 'مكان الإعلان', icon: 'home', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Placement', title: 'إدارة  مكان الإعلان ', type: 'link' },
				{ path: '/project/CreatePlacement', title: 'إضافة مكان إعلان ', type: 'link' }
			]
		},
		{
			title: 'التنبيهات', icon: 'radio', type: 'sub', badgeType: 'success'/*, badgeValue: '2'*/, active: false, children: [
				{ path: '/project/Notifications', title: 'التنبيهات المرسلة', type: 'link' },
				{ path: '/project/CreateNotification', title: 'إرسال تنبيه  ', type: 'link' }
			]
		 }
		//,
		// {
